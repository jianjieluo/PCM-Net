...
class DefaultTrainer(TrainerBase):
    ...
    def __init__(self, cfg):
        ...
        # NOTE: update iters_per_epoch if expr data_eff
        data_eff_ratio = cfg.DATALOADER.DATA_EFF_RATIO if cfg.DATALOADER.DATA_EFF_RATIO > 0.0 else 1.0
        assert data_eff_ratio <= 1.0
        self.iters_per_epoch = int(self.iters_per_epoch / data_eff_ratio)
