...
_C.DATALOADER.CLIP_THRES = -1.0
# _C.DATALOADER.CLIP_THRES = 0.7

_C.DATALOADER.CLIP_RET_DATA_ROOT = ''

_C.DATALOADER.CLIP_RET_SENT_NUM = 4

_C.DATALOADER.CLIP_RET_SENT_MAX_LEN = -1

_C.DATALOADER.CLIP_SEMANTIC_MASK_PROB = -1.0

_C.DATALOADER.DATA_EFF_RATIO = -1.0
...
_C.MODEL.VISUAL_EMBED.PROMPT_LEN = 10

_C.MODEL.VISUAL_EMBED.NOISE_INJ_VAR = -0.01 # < 0 for no injection

# ----------------------------------------------------------------------------
# DATALOADER CLIPTAG Settings
# ----------------------------------------------------------------------------
_C.MODEL.VISUAL_EMBED.CLIPTAG = CN()

_C.MODEL.VISUAL_EMBED.CLIPTAG.VOCAB_EMBED_PATH = ''

_C.MODEL.VISUAL_EMBED.CLIPTAG.TOPK = 3

_C.MODEL.VISUAL_EMBED.CLIPTAG.TOPK2 = 5.0

_C.MODEL.VISUAL_EMBED.CLIPTAG.THRES = 0.4

_C.MODEL.VISUAL_EMBED.CLIPTAG.REPLACE_TYPE = "top" # top, mean

_C.MODEL.VISUAL_EMBED.CLIPTAG.TYPE_VOCAB_SIZE = 0

_C.MODEL.VISUAL_EMBED.CLIPTAG.CLIP_MODEL = 'ViT-L/14'
...
_C.LOSSES.GAMMA_TYPE = 'batch' # word, sent, batch
...
_C.SCORER.CLIP_MODEL = 'ViT-B/32'

_C.SCORER.FINETUNED_CLIP_MODEL = ''

_C.SCORER.CLIP_SCORE_SCALE = 2.5 # followed clipscore paper `w`

_C.SCORER.GPT_SCORE_NAME = 'opt350m_score'

_C.SCORER.GPT_SCORE_PROMPT_MAX_LEN = 300

_C.SCORER.GPT_SCORE_SIGMOID_TRAN = True
